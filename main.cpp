 ...
 * @LastEditTime: 2021-08-19 14:13:13
...
int main(int, char**) {
  ...
  sph1->energy_attenuation = 0.2;
  sph1->diffuse_color = Vector3f(0.0, 0.0, 1.0);

  auto sph2 = std::make_unique<Sphere>(Vector3f(0.5, -0.5, -8), 1.5);
  sph2->ior = 1.5;
  sph2->energy_attenuation = 0.9;
  sph2->diffuse_color = Vector3f(0.0, 0.5, 0.0);

  auto sph3 = std::make_unique<Sphere>(Vector3f(-1, 0, -16), 2);
  sph3->energy_attenuation = 0.2;
